...
var file_simple_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x61, 0x70, 0x74, 0x65, 0x72, 0x36, 0x67, 0x72, 0x70, 0x63, 0x22, 0x23, 0x0a, 0x0d,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x32, 0x4e, 0x0a,
	0x06, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x12, 0x44, 0x0a, 0x05, 0x52, 0x6f, 0x75, 0x74, 0x65,
	0x12, 0x1b, 0x2e, 0x63, 0x68, 0x61, 0x70, 0x74, 0x65, 0x72, 0x36, 0x67, 0x72, 0x70, 0x63, 0x2e,
	0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e,
	0x63, 0x68, 0x61, 0x70, 0x74, 0x65, 0x72, 0x36, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x69, 0x6d,
	0x70, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x62, 0x06, 0x70,
...
var file_simple_proto_goTypes = []interface{}{
	(*SimpleRequest)(nil),  // 0: chapter6grpc.SimpleRequest
	(*SimpleResponse)(nil), // 1: chapter6grpc.SimpleResponse
}
var file_simple_proto_depIdxs = []int32{
	0, // 0: chapter6grpc.Simple.Route:input_type -> chapter6grpc.SimpleRequest
	1, // 1: chapter6grpc.Simple.Route:output_type -> chapter6grpc.SimpleResponse
...
func (c *simpleClient) Route(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chapter6grpc.Simple/Route", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Simple_Route_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chapter6grpc.Simple/Route",
	}
...
var _Simple_serviceDesc = grpc.ServiceDesc{
	ServiceName: "chapter6grpc.Simple",
